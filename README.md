...
`src/` exists only for maintenance. The guide is about 818 KB of content and code
...
data file is easier than in a 818 KB HTML file. `build.js` concatenates the parts in
