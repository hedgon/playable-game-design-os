...
`src/` exists only for maintenance. The guide is about 823 KB of content and code
...
data file is easier than in a 823 KB HTML file. `build.js` concatenates the parts in
...
src/                   optional: sources and maintenance scripts (see above)
  ...
  91-map.js            graph overview: pan/zoom/pinch, colours, reading panels
