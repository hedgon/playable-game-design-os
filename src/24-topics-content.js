...
T('encounters-and-enemies',{ d:'content', t:'Encounters and enemies', tag:'An enemy is a question the game asks. Design the question before the monster.',
  ...
  how:[`For each enemy, write the question it asks and the verbs that answer it. Remove or redesign any whose question duplicates another.`,`Build a compatibility matrix: which pairs create a new combined question?`,`Design encounters as sequences of questions with an intended tactical shift.`,`Check readability in the actual camera and lighting. Then test whether players change behaviour per enemy type.`],
