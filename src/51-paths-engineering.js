  ...
  stages:[
    { id:'s1', t:'Pick your platforms', level:'intermediate',
      ...
      steps:[
        ...
        { kind:'game', ref:'fortnite', why:'Fortnite is the platform-choice question made concrete: the same game a player queues into is also the runtime a UEFN creator’s island runs inside, so building on it means renting Epic’s engine, audience and economy rather than shipping your own.', do:'Read its business and lineage lenses, then note which of Fortnite’s own launches (Save the World, Battle Royale, Creative, UEFN) was a platform decision rather than a content update, and write one line on what each traded away for reach.', min:10 },
