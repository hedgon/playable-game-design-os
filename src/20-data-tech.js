...
TECH('finding-an-idea',[
  {n:'Want-first ideation', how:`Start from a specific player's complaints and wishes about named games, then derive concepts.`, fit:`Escaping genre reflexes.`, cost:`Requires real research; slower than brainstorming.`, alt:`Use the Idea Finder tool.`},
  {n:'Collision and constraint', how:`Combine unfamiliar elements and constrain by team/time/platform to force distinctiveness.`, fit:`Generating concepts you would not default to.`, cost:`Novelty without a want is still a bad idea.`, alt:`Generate, then test against wants.`},
  {n:'Want tests before building', how:`Stranger pitch, fake one-pager and one-day loop, with kill criteria.`, fit:`Testing desire before investment.`, cost:`Humility to kill an idea.`, alt:`Run all three; count replays and verb recognition.`}
]);
