...
console.log(`\n${Object.keys(TOPICS).length} topics, ${TOOLS.length} tools, ${CHECKLISTS.length} checklists, ${SMELLS.length} smells, ${DIAGNOSTICS.length} diagnostics, ${PROMPT_TEMPLATES.length} prompts, ${PLATFORMS.length} platform guides, ${REFERENCE_GAMES.length} reference games.`);
